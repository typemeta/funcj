...
public abstract class Extractors {
    ...
    public interface IntExtractor extends Extractor<Integer> {
        /**
         * Extract a int value from the given {@link ResultSet}.
    ...
    public interface LongExtractor extends Extractor<Long> {
        /**
         * Extract a long value from the given {@link ResultSet}.
         * @param rs        the result set
         * @return          the extracted value
         * @throws SQLException in the event of an error
         */
    ...
    public interface DblExtractor extends Extractor<Double> {
        /**
         * Extract a double value from the given {@link ResultSet}.
         * @param rs        the result set
         * @return          the extracted value
         * @throws SQLException in the event of an error
         */
