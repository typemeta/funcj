...
public class JsonNodeCodecFormat implements CodecFormat<JsValue, JsValue, Config> {

    protected final Config config;

    public JsonNodeCodecFormat(Config config) {
        this.config = config;
    }
    ...
    @Override
    public <T, RA extends ObjectMeta.Builder<T>> Codec<T, JsValue, JsValue, Config> createObjectCodec(
            Class<T> type,
