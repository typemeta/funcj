...
public class JsonToString implements JsonAlg<SideEffect.F<StringBuilder>> {
     ...
     * @return          the string representation of formatted JSON
     */
    public static StringBuilder toString(JsonValue jv, StringBuilder sb) {
        JsonAlgStack.apply(jv, new JsonToString()).apply(sb);
        return sb;
    }

    @Override
    public SideEffect.F<StringBuilder> nul() {
        return sb -> sb.append(JsonValue.NULL.toString());
    }
    ...
    @Override
    public SideEffect.F<StringBuilder> num(int value) {
    ...
    @Override
    public SideEffect.F<StringBuilder> num(BigDecimal value) {
        return sb -> sb.append(Utils.format(value));
    }
    ...
    @Override
    public SideEffect.F<StringBuilder> obj(Map<String, SideEffect.F<StringBuilder>> fields) {
        return sb -> {
            sb.append('{');
            boolean first = true;
